...
public abstract class GenericServlet extends HttpServlet {
    ...
    protected abstract String[][] fetchData(HttpServletRequest request);
    protected abstract void insert(HttpServletRequest request);
    ...
    private void readRequest(HttpServletRequest request,
        ...
        request.setAttribute("title", "Students Collection");
